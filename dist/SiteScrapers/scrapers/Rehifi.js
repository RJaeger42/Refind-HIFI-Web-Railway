...
exports.RehifiPlaywright = void 0;
exports.createRehifiPlaywright = createRehifiPlaywright;
 ...
 */
class RehifiPlaywright extends BaseScraper_1.BaseScraper {
    constructor(options) {
...
exports.RehifiPlaywright = RehifiPlaywright;
function createRehifiPlaywright(options) {
    return new RehifiPlaywright(options);
}
//# sourceMappingURL=Rehifi.js.map