...
exports.AkkelisAudioPlaywright = void 0;
exports.createAkkelisAudioPlaywright = createAkkelisAudioPlaywright;
 ...
 */
class AkkelisAudioPlaywright extends BaseScraper_1.BaseScraper {
    categoryUrl;
    constructor(options) {
    ...
    async search(query, minPrice, maxPrice) {
        ...
        try {
            ...
            for (const item of items) {
                ...
                // Extract price
                const priceElement = item.locator('.tws-api--price-current, .tws-api--price-regular');
                const priceText = await priceElement.textContent();
                const price = (0, utils_1.extractPrice)(priceText || '');
                // Extract description
...
exports.AkkelisAudioPlaywright = AkkelisAudioPlaywright;
function createAkkelisAudioPlaywright(options) {
    return new AkkelisAudioPlaywright(options);
}
//# sourceMappingURL=AkkelisAudio.js.map